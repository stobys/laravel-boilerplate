<div class="box box-warning @if ( ! session('usersPermissionsFiltered') ) collapsed-box @endif">
    {{ html()->form()->open() }}

        @include('_forms._form_filter_box_header', ['module' => 'users-permissions'])
        ...
        <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            {{ html()->label(trans('users-permissions.model.username'))->for('username') }}
            ...
            @include('_forms._form_filter_box_footer', ['module' => 'permissions'])
